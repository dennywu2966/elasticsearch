...
import org.elasticsearch.search.vectors.KnnVectorQueryable;
...
public class LanceVectorFieldMapper extends FieldMapper {
    ...
    public static final Mapper.TypeParser PARSER = new Mapper.TypeParser() {
        ...
        public Mapper.Builder parse(String name, Map<String, Object> node, MappingParserContext parserContext)
            ...
            if (readOnlyObj != null) {
                readOnly = Boolean.parseBoolean(readOnlyObj.toString());
            }
    ...
    public static class LanceVectorFieldType extends MappedFieldType implements KnnVectorQueryable {
        private final int dims;
        private final String similarity;
        private final LanceStorageConfig storage;
