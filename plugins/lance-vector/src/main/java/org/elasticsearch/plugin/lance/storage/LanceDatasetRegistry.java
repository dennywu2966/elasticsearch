...
public class LanceDatasetRegistry {
     ...
     * <ul>
     *   <li>URIs ending with .lance or containing .lance/ → RealLanceDataset</li>
     *   <li>URIs starting with embedded: → FakeLanceDataset (embedded JSON)</li>
     *   <li>Other URIs → FakeLanceDataset (external JSON file)</li>
     * </ul>
     *
