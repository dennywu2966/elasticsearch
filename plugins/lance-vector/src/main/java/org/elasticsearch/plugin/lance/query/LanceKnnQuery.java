...
public class LanceKnnQuery extends Query {
    ...
    public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
        ...
        LanceDatasetConfig config = new LanceDatasetConfig("_id", "vector", dims);
        LanceDataset dataset = LanceDatasetRegistry.getOrLoad(storageUri, dims, config);
        List<LanceDataset.Candidate> candidates = dataset.search(queryVector, numCandidates, similarity);
        logger.debug(
