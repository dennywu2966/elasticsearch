...
public class ShardAwareIntegrationTests extends ESTestCase {
    ...
    public void testLegacyOssUriReturnsSameForAllShards() throws Exception {
        ...
        LanceStorageConfig config = new LanceStorageConfig("external", "oss://bucket/dataset.lance", "_id", "vector", null, null, null);
    ...
    public void testIsShardAwareDetection() throws Exception {
        ...
        LanceStorageConfig legacy = new LanceStorageConfig("external", "oss://bucket/data.lance", "_id", "vector", null, null, null);
